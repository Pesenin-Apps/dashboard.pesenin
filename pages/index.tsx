  ...
  <>
    <section className="sign-in mx-auto pt-lg-100 pb-lg-100 pt-30 pb-47">
      <div className="container mx-auto">
        ...
        <h2 className="text-4xl fw-bold color-palette-0 mb-10">SIGN IN</h2>
        <p className="text-lg color-palette-0 m-0">Masukkan Data Yang Valid dan Benar.</p>

        <form action="">

          <div className="pt-30">
            <label htmlFor="email" className="form-label text-lg fw-medium color-palette-0 mb-10">Email Address</label>
            <input type="email" className="form-control rounded-pill text-lg" id="email" name="email" aria-describedby="email" placeholder="Masukkan Email Address" />
          </div>
          <div className="pt-30">
            <label htmlFor="password" className="form-label text-lg fw-medium color-palette-0 mb-10">Password</label>
            <input type="password" className="form-control rounded-pill text-lg" id="password" name="password" aria-describedby="password" placeholder="Masukkan Password" />
          </div>
