            ...
            <div className="waiter-lists mb-30">
              <div className="container">
                ...
                <div className="main-content main-content-table overflow-auto">
                  ...
                  <table className="table table-borderless">
                    ...
                    <tbody>
                      <tr data-category="pending" className="align-middle">
                        <td>
                          <p className="fw-medium color-palette-0 m-0">Waiter Pesenin 01</p>
                        </td>
                        <td>
                          <p className="fw-medium color-palette-0 m-0">waiter01@pesenin.id</p>
                        </td>
                        <td>
                          <span className="float-start icon-status not-active" />
                      ...
                      <tr data-category="success" className="align-middle">
                        <td>
                          <p className="fw-medium color-palette-0 m-0">Waiter Pesenin 02</p>
                        </td>
                        <td>
                          <p className="fw-medium color-palette-0 m-0">waiter02@pesenin.id</p>
                        </td>
                        <td>
                          <span className="float-start icon-status active" />
                          <p className="fw-medium text-start color-palette-0 m-0 position-relative">
                            Aktif
                  ...
                  <nav aria-label="Pagination Waiters">
